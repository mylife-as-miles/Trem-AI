...
const SettingsView: React.FC<SettingsViewProps> = ({ onNavigate }) => {
    ...
    const renderSidebarItem = (id: SettingsTab, label: string, icon: string, beta?: boolean) => (
        ...
        >
            <span className={`material-icons-outlined text-[20px] ${activeTab === id ? 'text-primary' : 'text-slate-500 dark:text-gray-500 group-hover:text-gray-300'}`}>{icon}</span>
            <span className="text-sm tracking-wide">{label}</span>
            {beta && (
                <span className="ml-auto text-[10px] font-bold bg-primary/20 text-primary px-1.5 py-0.5 rounded border border-primary/20 uppercase tracking-wider">Beta</span>
            )}
        </button>
    );
                                ...
                                <section>
                                    ...
                                    <div className="ml-9">
                                        <p className="text-gray-400 text-sm mb-4 leading-relaxed">
                                            You're on the Pro plan—built for high-throughput rendering and advanced AI context windows. Need even more GPU capacity? <a href="#" className="text-primary hover:underline">Learn more about enterprise nodes.</a>
                                        </p>
                                        <div className="flex items-center gap-4">
                                            <button className="px-4 py-2 bg-primary hover:bg-primary_hover text-white text-sm font-bold rounded-md shadow-lg shadow-purple-900/20 transition-all flex items-center gap-2">
                                                Upgrade Plan
                        ...
                        {activeTab === 'integrations' && (
                            <div className="space-y-8 fade-in">
                                ...
                                <div className="ml-9 space-y-6">
                                    ...
                                    <div>
                                        <a href="#" className="text-sm text-primary hover:text-primary_hover hover:underline mb-2 inline-block">Manage tokens in Frame.io Dashboard</a>
                                        ...
                                        <div className="bg-primary/5 border border-primary/10 rounded-lg p-5 mt-4">
                                            <h4 className="text-sm font-bold text-primary mb-2">Important</h4>
                            ...
                            <div className="space-y-8 fade-in">
                                ...
                                <div className="ml-9">
                                    ...
                                    <p className="text-xs text-gray-500 mt-4">
                                        ...
                                        <a href="#" className="text-primary hover:underline ml-1">Read best practices</a>.
                                    </p>
                                </div>
                            </div>
                        )}
