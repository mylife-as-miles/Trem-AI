                    ...
                    <div>
                        ...
                        <ul className="space-y-2 font-mono text-sm text-gray-400">
                            {['Last 24 Hours', 'Past Week', 'Past Month'].map((label) => (
                                ...
                                >
                                    <div className={`w-4 h-4 border rounded flex items-center justify-center transition-colors ${activeFilters.includes(label) ? 'bg-primary border-primary shadow-[0_0_8px_rgba(168,85,247,0.6)]' : 'border-white/20 group-hover:border-primary'}`}>
            ...
            <main className="flex-1 flex flex-col relative bg-background-dark overflow-hidden">
                <header className="h-20 flex-shrink-0 flex items-center justify-between px-8 border-b border-white/10 bg-black/80 backdrop-blur-md sticky top-0 z-30">
                    <div className="flex flex-col justify-center">
                        ...
                        <div className="flex items-center gap-2 text-xs font-mono text-gray-500 mt-1">
                            ...
                            <span className="text-white/20">/</span>
                            <span className="text-primary glow-text">media</span>
                        </div>
                    </div>
                    <div className="flex items-center gap-6 flex-1 justify-end">
                        <div className="relative group max-w-xl w-full">
                            <div className="absolute -inset-0.5 bg-gradient-to-r from-primary/50 to-purple-900/50 rounded-lg blur opacity-30 group-hover:opacity-60 transition duration-500"></div>
                            <div className="relative flex items-center bg-black border border-white/10 rounded-lg overflow-hidden group-focus-within:border-primary/50 transition-colors shadow-[0_0_15px_rgba(0,0,0,0.5)]">
                        ...
                        <button className="bg-primary hover:bg-primary_hover text-white px-5 py-2.5 rounded-lg text-sm font-medium font-display tracking-wide shadow-[0_0_20px_rgba(168,85,247,0.4)] hover:shadow-[0_0_30px_rgba(168,85,247,0.6)] transition-all flex items-center gap-2 whitespace-nowrap active:scale-95">
                ...
                <div className="flex-1 overflow-y-auto p-8 scroll-smooth">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 pb-20">
                            ...
                            <div className="absolute inset-0 bg-black/60 backdrop-blur-md opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col justify-between p-5 border border-primary/30">
                                <div className="flex flex-wrap gap-2 transform -translate-y-2 group-hover:translate-y-0 transition-transform duration-300 delay-75">
                                    {['Rain', 'City', 'Sad', 'Night'].map(tag => (
                                        <span key={tag} className="px-2.5 py-1 rounded-full bg-primary/20 border border-primary/50 text-purple-200 text-[10px] font-mono tracking-wide shadow-[0_0_10px_rgba(168,85,247,0.2)]">{tag}</span>
                                    ))}
                                </div>
                                <div className="font-mono text-xs text-primary bg-black/80 p-3 rounded border border-primary/20 transform scale-95 group-hover:scale-100 transition-transform duration-300 delay-100 shadow-[0_0_20px_rgba(168,85,247,0.15)] relative overflow-hidden">
                                    <div className="absolute top-0 right-0 w-2 h-2 bg-green-500 rounded-full animate-ping"></div>
                                    <span className="text-gray-500">{`{`}</span><br />
                                    &nbsp;&nbsp;<span className="text-purple-300">"object"</span>: <span className="text-green-400">"red_shoes"</span>,<br />
                                    &nbsp;&nbsp;<span className="text-purple-300">"motion"</span>: <span className="text-green-400">"running"</span><br />
                                ...
                                <div className="font-mono text-sm text-white bg-black/60 p-2 rounded border-l-2 border-primary transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300 delay-150 relative">
                                    <div className="absolute -left-0.5 top-0 bottom-0 w-0.5 bg-primary shadow-[0_0_8px_rgba(168,85,247,0.8)]"></div>
                        ...
                        {/* Clip 2 */}
                        <div className="relative group aspect-[16/9] bg-black rounded-lg overflow-hidden border border-white/10 hover:border-purple-500/50 transition-all duration-300">
                            ...
                            <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                <span className="material-icons-outlined text-white text-4xl drop-shadow-lg">play_circle</span>
                            </div>
                        </div>
